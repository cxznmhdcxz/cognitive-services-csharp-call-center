...
namespace CallCenterSample.Controls
{
    ...
    /// </summary>
    public partial class PositiveSentimentControl : UserControl
    {
        public static readonly DependencyProperty SentimentProperty =
            DependencyProperty.Register(
            "Sentiment",
            typeof(double),
            typeof(PositiveSentimentControl),
        ...
        {
            PositiveSentimentControl control = (PositiveSentimentControl)d;
            control.UpdateSentimentPointer();
        }

        public PositiveSentimentControl()
        {
            InitializeComponent();
        }
